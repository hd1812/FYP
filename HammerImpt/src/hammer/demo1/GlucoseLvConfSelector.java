...
public class GlucoseLvConfSelector implements T3Functor<Pair<Dictionary<String>,Dictionary<String>>,TreeMap<String,RankedWeaver>,State,State>
{
			...
			for(String str:tempSignals.getKeys()){
					...
					if(actions_.contains(str)){
						if(actionConfidence_.get(str)<RankedWeaver_.weaver.getConfidence()){
							actions_.put(str,(String) tempSignals.get(str));
